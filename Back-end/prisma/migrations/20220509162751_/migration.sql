/*
  ...
  - You are about to drop the column `quilometragem` on the `vistoria` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `vistoria` DROP COLUMN `quilometragem`,
