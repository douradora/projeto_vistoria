/*
  ...
  - You are about to drop the column `combustivel` on the `vistoria` table. All the data in the column will be lost.
  ...
  - Added the required column `veiculo_combustivel` to the `Vistoria` table without a default value. This is not possible if the table is not empty.
  - Added the required column `veiculo_quilometragem` to the `Vistoria` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `vistoria` DROP COLUMN `combustivel`,
    ADD COLUMN `veiculo_combustivel` DOUBLE NOT NULL,
    ADD COLUMN `veiculo_quilometragem` INTEGER NOT NULL,
